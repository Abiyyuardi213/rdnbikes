...
@section('title', 'Tambah Kategori Produk - RDN Bikes Admin')
...
<div class="card card-custom border-0 shadow-sm col-lg-8">
    <div class="card-header bg-dark text-white rounded-0 py-3">
        <h5 class="card-title text-uppercase fw-bold mb-0" style="font-family: var(--font-display); font-size: 0.9rem; letter-spacing: 1px;"><i class="bi bi-plus-circle text-turquoise me-2"></i> Tambah Kategori Baru</h5>
    </div>
    <div class="card-body p-4">
        ...
        <form action="{{ route('admin.categories.store') }}" method="POST">
            ...
            <!-- Category Slug Field -->
            <div class="mb-3">
                <label for="slug" class="form-label form-label-custom">Slug Handle</label>
                <input type="text" 
                       name="slug" 
                       id="slug" 
                       class="form-control form-control-custom" 
                       placeholder="Contoh: bikes, apparel" 
                       value="{{ old('slug') }}">
                <div class="form-text text-muted" style="font-size: 0.75rem;">URL-friendly handle. Jika dikosongkan, sistem akan otomatis menjadikannya huruf kecil & memberi tanda hubung sesuai Nama Kategori.</div>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="description" 
                          ...
                          rows="4" 
                          class="form-control form-control-custom" 
                          placeholder="Masukkan keterangan penjelas kategori produk di sini...">{{ old('description') }}</textarea>
            </div>
            ...
            <div class="d-flex justify-content-end gap-2 border-top pt-3">
                ...
                <button type="submit" class="btn btn-turquoise rounded-0 px-4 text-uppercase fw-bold" style="font-family: var(--font-display); font-size: 0.75rem; letter-spacing: 0.5px;">Simpan Kategori</button>
            </div>
        </form>
    </div>
</div>
