...
@section('title', 'Detail Produk Komponen')
...
<div class="mb-4">
    ...
    <h2 class="display-font mt-1 fw-extrabold" style="text-transform: uppercase;">Detail Komponen #{{ $product->id }}</h2>
</div>
    ...
    <div class="col-lg-8">
        ...
        <div class="card card-custom mb-4">
            <div class="card-header">
                Informasi Utama Produk Komponen
            </div>
            <div class="card-body">
                <table class="table table-borderless align-middle mb-0" style="font-size: 0.85rem;">
                    <tr>
                        <th class="ps-0 text-muted" style="width: 150px;">Nama Komponen</th>
                    ...
                    <tr>
                        ...
                        <td>: {{ $product->category ? $product->category->name : 'Components' }}</td>
                    </tr>
                    <tr>
    ...
    <div class="col-lg-4">
        ...
        <div class="card card-custom">
            ...
            <div class="card-body d-grid gap-2">
                <a href="{{ route('admin.components.edit', $product->id) }}" class="btn btn-outline-custom py-2"><i class="bi bi-pencil-square me-2"></i> Edit Data Komponen</a>
                <hr class="my-2">
                <form action="{{ route('admin.components.destroy', $product->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus komponen \'{{ $product->name }}\'? Tindakan ini tidak dapat dibatalkan.')">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn btn-danger w-100 py-2 text-white bg-danger border-danger"><i class="bi bi-trash me-2"></i> Hapus Komponen</button>
                </form>
            </div>
        </div>
    </div>
