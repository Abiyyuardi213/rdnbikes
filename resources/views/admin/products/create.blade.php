...
<div class="mb-4">
    ...
    <h2 class="display-font mt-1 fw-extrabold" style="text-transform: uppercase;">Tambah Sepeda Baru</h2>
</div>
                ...
                <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="subcategory" id="subcategory" class="form-select form-control-custom @error('subcategory') is-invalid @enderror" required>
                                ...
                                <option value="Road Bikes" {{ old('subcategory') == 'Road Bikes' ? 'selected' : '' }}>Road Bikes</option>
                                <option value="Gravel Bikes" {{ old('subcategory') == 'Gravel Bikes' ? 'selected' : '' }}>Gravel Bikes</option>
                            </select>
                            @error('subcategory')
                                <div class="invalid-feedback fw-semibold">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="specs[Frame]" id="specs_frame" class="form-control form-control-custom" placeholder="Contoh: Torayca T1100 Carbon" value="{{ old('specs.Frame') }}" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="specs_fork" class="form-label form-label-custom">Fork</label>
                            <input type="text" name="specs[Fork]" id="specs_fork" class="form-control form-control-custom" placeholder="Contoh: RDN Carbon Aero Integrated" value="{{ old('specs.Fork') }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="specs[Groupset]" id="specs_groupset" class="form-control form-control-custom" placeholder="Contoh: Shimano Ultegra Di2 12-Speed" value="{{ old('specs.Groupset') }}" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="specs_wheelset" class="form-label form-label-custom">Wheelset</label>
                            <input type="text" name="specs[Wheelset]" id="specs_wheelset" class="form-control form-control-custom" placeholder="Contoh: RDN Carbon Profile 50mm" value="{{ old('specs.Wheelset') }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="specs[Tires]" id="specs_tires" class="form-control form-control-custom" placeholder="Contoh: Continental GP 5000 700x28c" value="{{ old('specs.Tires') }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="specs_cockpit" class="form-label form-label-custom">Cockpit (Stang)</label>
                            <input type="text" name="specs[Cockpit]" id="specs_cockpit" class="form-control form-control-custom" placeholder="Contoh: Integrated Carbon Barstem" value="{{ old('specs.Cockpit') }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="specs[Saddle]" id="specs_saddle" class="form-control form-control-custom" placeholder="Contoh: Fizik Antares Versus EVO" value="{{ old('specs.Saddle') }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="specs_weight" class="form-label form-label-custom">Weight (Bobot) <span class="text-danger">*</span></label>
                            <input type="text" name="specs[Weight]" id="specs_weight" class="form-control form-control-custom" placeholder="Contoh: 7.2 kg" value="{{ old('specs.Weight') }}" required>
                        </div>
                    </div>
                    ...
                    <div class="d-flex gap-2 justify-content-end mt-4 border-top pt-3">
                        ...
                        <button type="submit" class="btn btn-turquoise py-2 px-4"><i class="bi bi-save me-2"></i> Simpan Sepeda</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="col-lg-5">
        <div class="card card-custom bg-light border-0">
            ...
            <div class="card-body text-muted" style="font-size: 0.85rem; line-height: 1.6;">
                <p>Silakan ikuti instruksi berikut untuk memastikan kualitas data produk sepeda yang ditampilkan di storefront utama:</p>
                <ul class="ps-3 mb-4">
                    <li class="mb-2"><strong>Otomatisasi Slug</strong>: URL slug (handle) untuk navigasi detail produk akan otomatis dibuat berdasarkan Nama Sepeda (e.g. "RDN Climber SL" menjadi "rdn-climber-sl").</li>
                    <li class="mb-2"><strong>Auto Kategori</strong>: Semua produk sepeda yang ditambahkan melalui form ini secara otomatis diasosiasikan dengan kategori database <code>Bikes</code> (Kategori ID Default).</li>
                    <li class="mb-2"><strong>Dukungan Gambar</strong>: Sistem akan mendeteksi sub-kategori pilihan Anda dan mengarahkan path gambar ke asset lokal yang sesuai:
                        <ul class="ps-3 mt-1">
                            <li>Road Bikes ➔ <code>/images/hero_road_bike.png</code></li>
                            <li>Gravel Bikes ➔ <code>/images/category_gravel.png</code></li>
                        </ul>
                    </li>
                    <li class="mb-2"><strong>Format Spesifikasi</strong>: Isian Frame, Groupset, dan Weight wajib diisi sebagai parameter minimal spesifikasi.</li>
                </ul>
                <div class="p-3 bg-white border border-info border-start border-4">
                    ...
                    Detail sepeda yang Anda simpan akan secara otomatis terintegrasi dengan generator tombol pesan instan WhatsApp di halaman detail storefront pelanggan.
                </div>
            </div>
        </div>
    </div>
