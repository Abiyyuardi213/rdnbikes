...
@section('title', 'Cycling Jerseys - RDN Bikes')

@section('content')
<!-- Page Hero Banner -->
<section class="position-relative py-5 text-white d-flex align-items-center" style="min-height: 350px; background: linear-gradient(rgba(0,0,0,0.65), rgba(0,0,0,0.65)), url('/images/category_jerseys.png') center/cover no-repeat;">
    <div class="container text-center py-5">
        <span class="text-uppercase fw-bold text-turquoise mb-2 d-inline-block" style="font-family: var(--font-display); font-size: 0.85rem; letter-spacing: 3px;">Elite Cycling Apparel</span>
        <h1 class="display-4 fw-extrabold text-uppercase mb-3" style="font-family: var(--font-display); letter-spacing: 1px;">Cycling Jerseys</h1>
        <p class="lead mx-auto mb-0" style="max-width: 600px; font-weight: 300; font-size: 1.1rem; line-height: 1.6;">Dibuat dari kain premium berpori mikro yang melepas panas tubuh dengan cepat, potongan aero tanpa kerutan, dan resleting YKK berkualitas.</p>
    </div>
</section>
    ...
    <div class="container d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0" style="font-size: 0.85rem; font-family: var(--font-display); font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">
                ...
                <li class="breadcrumb-item active text-turquoise" aria-current="page">Cycling Jerseys</li>
            </ol>
        </nav>
        <span class="text-muted" style="font-size: 0.85rem;">Menampilkan {{ count($products) }} Model Jersey Balap</span>
    </div>
</section>
        ...
        <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="product-card">
                        ...
                        <div class="product-card-info">
                            <div>
                                <div class="product-card-category">{{ $product['specs']['Material'] ?? 'Premium Fabric' }}</div>
            ...
            @empty
                <div class="col-12 text-center py-5">
                    <p class="text-muted">Tidak ada produk cycling jersey yang tersedia saat ini.</p>
                </div>
            @endforelse
        </div>
    </div>
...
<!-- Sublimation Custom Apparel CTA Section -->
<section class="py-5 bg-dark text-white text-center position-relative overflow-hidden">
    <div class="container py-4 position-relative" style="z-index: 2;">
        <h3 class="display-font text-uppercase text-white fw-bold mb-3">Mau Desain Sendiri untuk Komunitas Anda?</h3>
        <p class="text-muted-custom mx-auto mb-4" style="max-width: 600px; color: #bbbbbb;">Kami melayani pesanan jersey full custom sublimasi tanpa minimal order. Desain grafis & mockup 3D gratis dibantu tim desainer kami.</p>
        <a href="{{ route('custom-jersey') }}" class="btn btn-turquoise px-5 py-3 text-uppercase fw-bold" style="font-size: 0.85rem; letter-spacing: 1px;"><i class="bi bi-palette-fill me-2"></i> Info Custom Jersey RDN</a>
    </div>
</section>
@endsection
