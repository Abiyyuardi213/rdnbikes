...
@section('title', 'Socks & Accessories - RDN Bikes')

@section('content')
<!-- Page Hero Banner -->
<section class="position-relative py-5 text-white d-flex align-items-center" style="min-height: 350px; background: linear-gradient(rgba(0,0,0,0.65), rgba(0,0,0,0.65)), url('/images/category_jerseys.png') center/cover no-repeat; filter: hue-rotate(180deg) saturate(30%);">
    <div class="container text-center py-5">
        <span class="text-uppercase fw-bold text-turquoise mb-2 d-inline-block" style="font-family: var(--font-display); font-size: 0.85rem; letter-spacing: 3px;">Essential Gear Accessories</span>
        <h1 class="display-4 fw-extrabold text-uppercase mb-3" style="font-family: var(--font-display); letter-spacing: 1px;">Socks & Accessories</h1>
        <p class="lead mx-auto mb-0" style="max-width: 600px; font-weight: 300; font-size: 1.1rem; line-height: 1.6;">Lengkapi kebutuhan gowes Anda dengan kaos kaki aerodinamis berperekat silikon, topi sepeda summer, arm warmers, dan sarung tangan taktis kulit.</p>
    </div>
</section>
    ...
    <div class="container d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0" style="font-size: 0.85rem; font-family: var(--font-display); font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">
                ...
                <li class="breadcrumb-item active text-turquoise" aria-current="page">Socks & Accessories</li>
            </ol>
        </nav>
        <span class="text-muted" style="font-size: 0.85rem;">Menampilkan {{ count($products) }} Aksesoris Penting</span>
    </div>
</section>
        ...
        <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="product-card">
                        ...
                        <div class="product-card-info">
                            <div>
                                <div class="product-card-category">{{ $product['specs']['Material'] ?? 'Premium Accessory' }}</div>
            ...
            @empty
                <div class="col-12 text-center py-5">
                    <p class="text-muted">Tidak ada produk aksesoris sepeda yang tersedia saat ini.</p>
                </div>
            @endforelse
        </div>
    </div>
