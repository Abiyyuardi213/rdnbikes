...
@section('title', 'Bike Components - RDN Bikes')

@section('content')
<!-- Page Hero Banner -->
<section class="position-relative py-5 text-white d-flex align-items-center" style="min-height: 350px; background: linear-gradient(rgba(0,0,0,0.65), rgba(0,0,0,0.65)), url('/images/hero_road_bike.png') center/cover no-repeat; filter: grayscale(30%);">
    <div class="container text-center py-5">
        <span class="text-uppercase fw-bold text-turquoise mb-2 d-inline-block" style="font-family: var(--font-display); font-size: 0.85rem; letter-spacing: 3px;">High Grade Performance Upgrades</span>
        <h1 class="display-4 fw-extrabold text-uppercase mb-3" style="font-family: var(--font-display); letter-spacing: 1px;">Bike Components</h1>
        <p class="lead mx-auto mb-0" style="max-width: 600px; font-weight: 300; font-size: 1.1rem; line-height: 1.6;">Upgrade performa kayuhan dan efisiensi mekanis Anda dengan komponen transmisi elektronik, pengereman hidrolik, dan wheelset terbaik dunia.</p>
    </div>
</section>
    ...
    <div class="container d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0" style="font-size: 0.85rem; font-family: var(--font-display); font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">
                ...
                <li class="breadcrumb-item active text-turquoise" aria-current="page">Components</li>
            </ol>
        </nav>
        <span class="text-muted" style="font-size: 0.85rem;">Menampilkan {{ count($products) }} Model Komponen Premium</span>
    </div>
</section>
        ...
        <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="product-card">
                        ...
                        <div class="product-card-info">
                            <div>
                                <div class="product-card-category">{{ $product['specs']['Brand'] ?? 'Components' }}</div>
            ...
            @empty
                <div class="col-12 text-center py-5">
                    <p class="text-muted">Tidak ada produk komponen sepeda yang tersedia saat ini.</p>
                </div>
            @endforelse
        </div>
    </div>
...
<section class="py-5 bg-dark text-white text-center position-relative overflow-hidden">
    <div class="container py-4 position-relative" style="z-index: 2;">
        <h3 class="display-font text-uppercase text-white fw-bold mb-3">Konsultasi Kecocokan Komponen Gratis</h3>
        <p class="text-muted-custom mx-auto mb-4" style="max-width: 600px; color: #bbbbbb;">Kami memastikan komponen, groupset, atau wheelset yang Anda pesan 100% kompatibel dengan frame sepeda kesayangan Anda.</p>
        <a href="https://wa.me/628123456789?text=Halo%20RDN%20Bikes,%20saya%20ingin%20tanya%20kecocokan%20komponen%20sepeda." target="_blank" class="btn btn-turquoise px-5 py-3"><i class="bi bi-whatsapp me-2"></i> Hubungi WhatsApp Component Specialist</a>
    </div>
</section>
@endsection
